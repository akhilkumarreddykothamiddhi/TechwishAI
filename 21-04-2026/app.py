...
SNOWFLAKE_ROLE      = cfg("SNOWFLAKE_ROLE", "")
...
def img_to_b64(filename: str) -> str:
    for ext in ["", ".png", ".jpg", ".jpeg", ".svg", ".webp"]:
        for base in [pathlib.Path("."), pathlib.Path(__file__).parent]:
...
<div id="logo-wrap" class="logo-row">
  <img id="tw-logo" src="{light_src or dark_src}"
       style="max-width:150px; height:auto; display:{'block' if (light_src or dark_src) else 'none'};" />
